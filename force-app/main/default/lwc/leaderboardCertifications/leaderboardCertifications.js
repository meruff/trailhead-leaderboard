...
export default class LeaderboardCertifications extends LightningElement {
                        ...
                        this.dispatchEvent(
                            new CustomEvent(
                                "updatesectionlabel", 
                                {
                                    detail: { 
                                        name: "certifications", 
                                        label: this.certifications.length + ((this.certifications.length === 1) ?  " Certification" : " Certifications")
                                    }
                                }
                            )
                        );
    ...
    get showNoCertificationsMessage() {
        return !this.showSpinner && (!this.certificationsDisplayed || this.certificationsDisplayed === 0);
    }
    ...
    get displayShowMore() {
        return this.certifications && this.certifications.length > 5 && this.certificationsDisplayed.length !== this.certifications.length;
    }
